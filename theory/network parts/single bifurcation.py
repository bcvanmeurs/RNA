...
#plt.plot(t,I1,linewidth = 1 , label = 'outflow before bifurcation')
#plt.plot(t,I2,linewidth = 1 , label = 'outflow before bifurcation')
...
O1 = calc_Out(I1,C1)
plt.plot(t, O1 ,'r',linewidth = 1, label = 'outflow 1')
...
O2 = calc_Out(I2,C2)
plt.plot(t, O2 ,linewidth = 1, label = 'outflow 2')
